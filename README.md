...
window — the kind of desktop client that has grown around Claude Code and Codex, built for
Muse: conversations organised by project, the work visible as it happens, and an opt-in
switch that lets the agent see your screen and drive your applications.
...
conversation that asked for it — a stale one is refused rather than silently applied.
...
in [docs/ROADMAP.md](docs/ROADMAP.md) — it is honest about what is measured and what is not,
