...
**Limite restante :** le bail natif arbitre désormais les processus Tauri et les définitions/runs sont durables sous app data, mais aucun host n'est encore lancé lorsque l'application est complètement fermée. La preuve native de l'état du host après crash et le service OS de fond restent à qualifier.
