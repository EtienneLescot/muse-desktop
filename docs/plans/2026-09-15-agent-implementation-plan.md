...
**Reste :** le protocole MSP ne fournit pas encore de verrouillage de fichiers, de résultat writer structuré ni d’annulation atomique confirmée. Garder le dispatch sur le chemin normal start/send tant que le contrat natif n’est pas vérifié ; ajouter ensuite les locks host, la collecte de résultat et une intégration séparée des changements.
