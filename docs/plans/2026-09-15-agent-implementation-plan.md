...
**Reste :** package/version/source réel, mise à jour/rollback de distribution, arrêt pendant appel et catalogue des outils réellement visibles par le moteur Muse ; l'autorité de permission par appel reste à confirmer côté host, la garde UI étant maintenant explicite.
