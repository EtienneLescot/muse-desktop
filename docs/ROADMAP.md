...
| M0-14 | Disposer de contrôles reproductibles avant fusion | — | — | Partielle | Unitaire | CI build/Node/Rust et artefacts d'échec bornés ajoutés sans credentials ni binaire sidecar ; fixture MSP livrée ; restent les scénarios natifs A/B et la panne d'envoi avec l'interface Tauri |
