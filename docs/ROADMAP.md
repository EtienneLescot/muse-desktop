...
- **Formats bureautiques :** les conteneurs DOCX, XLSX et PPTX jusqu'à 5 MiB sont décompressés localement avec `fflate`, puis seuls les paragraphes, la première feuille bornée ou le texte des diapositives sont affichés dans le même tableau accessible. Macros, formules, relations et médias incorporés ne sont jamais exécutés ni interprétés ; un conteneur malformé retombe sur l'ouverture système.
