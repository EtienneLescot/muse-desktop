...
| M4-05 | Produire/consulter des images et documents riches | Adapté | Présente | Partielle | Unitaire | Artefacts Markdown versionnés, prévisualisation sûre, tableaux CSV/TSV/JSON bornés, réutilisation et export texte local livrés ; capacités moteur image/document, fichiers réellement générés, previews bureautiques et qualification native restent à faire |
