...
- **Validation** : `npm test` (561 tests Node, dont cinq tests fixture), build frontend et 112 tests Rust du superviseur verts. La fixture s'exécute aussi dans le job Node de la CI depuis un clone propre.
