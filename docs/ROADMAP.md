...
- **Validation** : `npm test` (551 tests Node, dont cinq tests fixture), build frontend et 107 tests Rust du superviseur verts. La fixture s'exécute aussi dans le job Node de la CI depuis un clone propre.
