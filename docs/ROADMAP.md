...
- ◐ **M1-05 — Ouvrir et utiliser un terminal du projet** *(Global : —)*
  ...
  - **Reste :** commande interactive longue (entrée en attente) et `Resize` visuel sur les trois OS ; validation ANSI/raccourcis. Le défaut historique ci-dessous garde sa trace.
