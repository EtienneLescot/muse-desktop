...
- **Validation :** 3 tests Node couvrent le parsing borné, les doublons et les selectors namespacés ; tests Rust couvrent la validation des parts `skill` et la suite de référence reste verte (592 tests Node, 131 tests Rust au 17/09/2026).
